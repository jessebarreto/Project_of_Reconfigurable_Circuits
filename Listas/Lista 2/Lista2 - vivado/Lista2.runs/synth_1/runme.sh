...
HD_PWD='C:/Xilinx/Projetos_PCR/Lista2/Lista2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lista2_matrix_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lista2_matrix_mult.tcl
