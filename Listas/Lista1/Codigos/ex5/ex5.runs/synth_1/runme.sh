...
HD_PWD='C:/Xilinx/Projetos_PCR/Lista1/ex5/ex5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex5_greaterthan_4bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex5_greaterthan_4bits.tcl
