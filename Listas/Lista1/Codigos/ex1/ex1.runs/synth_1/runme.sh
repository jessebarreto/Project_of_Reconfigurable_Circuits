...
HD_PWD='C:/Xilinx/Projetos_PCR/Lista1/ex1/ex1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exerc1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exerc1.tcl
