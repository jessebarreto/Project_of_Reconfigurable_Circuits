...
HD_PWD='C:/Xilinx/Projetos_PCR/Lista1/ex4/ex4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex4.tcl -notrace
