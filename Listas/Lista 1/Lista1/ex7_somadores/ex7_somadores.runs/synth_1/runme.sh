...
HD_PWD='C:/Xilinx/Projetos_PCR/Lista1/ex7_somadores/ex7_somadores.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex7_somador_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex7_somador_2.tcl
