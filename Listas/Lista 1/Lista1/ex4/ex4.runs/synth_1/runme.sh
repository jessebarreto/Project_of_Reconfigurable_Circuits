...
HD_PWD='C:/Xilinx/Projetos_PCR/Lista1/ex4/ex4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex4.tcl
