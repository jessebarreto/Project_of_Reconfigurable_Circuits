...
HD_PWD='C:/Xilinx/Projetos_PCR/Lista1/ex3/ex3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex3.tcl
