...
HD_PWD='C:/Xilinx/Projetos_PCR/Lista1/ex3/ex3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex3.tcl -notrace
